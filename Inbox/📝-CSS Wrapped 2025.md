...
source: "https://chrome.dev/css-wrapped-2025/"
tags:
  - "source/article"
  - "status/todo"
author:
...
Using `popover="hint"` combined with [interest invokers](https://chrome.dev/css-wrapped-2025/#interest-invokers) (the `[interestfor]` attribute), make it much easier to build layered UI elements like tooltips, hover cards, and previews declaratively in HTML and CSS, without complex JavaScript workarounds. This pairing allows for dual-purpose interaction patterns (for example, hover to preview, click to navigate) and better management of multiple on-screen layers.

<video src="./video/popover-hint.mp4" width="1986" height="1180" controls="">Your browser does not support video</video>
...
![Customizable select diagram showing the various new parts](https://chrome.dev/css-wrapped-2025/images/clay-select.png)
...
<video src="./video/select.mp4" width="1280" height="720" controls="">Your browser does not support video</video>
...
- [Codepen collection of select demos](https://codepen.io/collection/BNZjPe?cursor=eyJwYWdlIjoyfQ==)
- [OpenUI Explainer](https://open-ui.org/components/customizableselect/)
...
![Illustration showing a horizontal carousel with left and right scroll buttons on either side, and scroll markers below the carousel indicating the current position.](https://chrome.dev/css-wrapped-2025/images/carousel-buttons.png)
...
```
![Illustration showing a horizontal carousel with left and right scroll buttons on either side, and scroll markers below the carousel indicating the current position.](https://chrome.dev/css-wrapped-2025/images/carousel-markers.png)
...
- [Make accessible carousels](https://developer.chrome.com/blog/accessible-carousel)
...
```
<video src="./video/anchored-cq.mp4" width="1280" height="720" controls="">Your browser does not support video</video>
...
The new `interestfor` attribute solves this by providing a native, declarative way to style an element when users "show interest" in it without fully activating it. It's invoked similarly to the [`commandfor` attribute](https://chrome.dev/css-wrapped-2025/#invoker-commands), but, instead of a click, `interestfor` is activated when a user "shows interest" in an element, such as by hovering over it with a mouse or focusing it with a keyboard. When paired with [`popover="hint"`](https://chrome.dev/css-wrapped-2025/#popover-hint), it becomes incredibly easy to create layered UI elements like tooltips and hovercards without any custom JavaScript.
...
<video src="./video/interest-invokers.mp4" width="1280" height="720" controls="">Your browser does not support video</video>
...
- [Open UI explainer](https://open-ui.org/components/interest-invokers.explainer/)
- [`interestfor` Polyfill](https://github.com/mfreed7/interestfor)
...
<video src="./video/scroll-state-container-queries.mp4" width="1922" height="1082" controls="">Your browser does not support video</video>
...
<video src="./video/sibling-index.mp4" width="1010" height="816" controls="">Your browser does not support video</video>
...
```
<video src="./video/scrollintoview-container-nearest.mp4" width="1306" height="820" controls="">Your browser does not support video</video>
...
<video src="./video/nested-view-transition-groups.mp4" width="2952" height="2014" controls="">Your browser does not support video</video>
...
<video src="./video/dom-state-preserving-move.mp4" width="1964" height="2304" controls="">Your browser does not support video</video>
...
![Blobby monster lounging in an ergonomic chair.](https://chrome.dev/css-wrapped-2025/biomes/ergonomics-header.jpg)
...
```
![A star shape filled partially with gold color to represent a rating, with the numeric rating shown in the center.](https://chrome.dev/css-wrapped-2025/images/attr-demo.png)
...
Cookie banner demo that uses `ToggleEvent.source`. The demo also uses [Invoker Commands](https://chrome.dev/css-wrapped-2025/#invoker-commands)
...
![Illustration showing the ascender and descender line of a typeface.](https://chrome.dev/css-wrapped-2025/images/text-box-1.png)
...
![Illustration showing the cap height of a typeface.](https://chrome.dev/css-wrapped-2025/images/text-box-2.png)
...
![Flag shape screenshot.](https://chrome.dev/css-wrapped-2025/images/shape-1.png)
...
![Blog shape screenshot.](https://chrome.dev/css-wrapped-2025/images/shape-2.png)
...
<video src="./video/function.mp4" width="1280" height="720" controls="">Your browser does not support video</video>
```css
...
![Weather cards with different background colors and icons based on the weather and chance of rain.](https://chrome.dev/css-wrapped-2025/images/weather-cards.png)
...
- [Range syntax for style queries blog post](https://una.im/range-style-queries)
...
- `scoop`
- `squircle`
<video src="./video/corner-shape.mp4" width="1280" height="720" controls="">Your browser does not support video</video>
...
![CSS flower shape made with corner-shape property.](https://chrome.dev/css-wrapped-2025/images/corner-shape.png)
```css
.top-left-petal {
...
- [#CodePenChallenge: CSS Shape](https://codepen.io/collection/bGBzdV)
...
[Container Queries reach Baseline Widely available](https://web.dev/blog/baseline-digest-aug-2025#css_container_queries_are_now_baseline_widely_available) [#Interop2025 yields big leaps for CSS anchor positioning](https://wpt.fyi/interop-2025) [Popover API lands in all browser engines](https://web.dev/blog/popover-baseline) [Baseline widely available: CSS trigonometric functions](https://web.dev/articles/css-trig-functions) [Same-document view transitions become Baseline Newly available](https://web.dev/blog/same-document-view-transitions-are-now_baseline_newly_available) [Container Queries reach Baseline Widely available](https://web.dev/blog/baseline-digest-aug-2025#css_container_queries_are_now_baseline_widely_available) [#Interop2025 yields big leaps for CSS anchor positioning](https://wpt.fyi/interop-2025) [Popover API lands in all browser engines](https://web.dev/blog/popover-baseline) [Baseline widely available: CSS trigonometric functions](https://web.dev/articles/css-trig-functions) [Same-document view transitions become Baseline Newly available](https://web.dev/blog/same-document-view-transitions-are-now_baseline_newly_available)